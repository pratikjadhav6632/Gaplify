...
import { FaHistory, FaBrain, FaMap, FaCalendar, FaClock, FaChartLine, FaUserTie } from 'react-icons/fa';
      ...
      <div className="container-responsive">
        ...
        <div className="text-center mb-12 animate-on-scroll">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Track your progress and revisit your skill analyses and learning roadmaps
          </p>
        </div>
          ...
          <div className="animate-on-scroll" style={{ animationDelay: '0.1s' }}>
            <div className="card p-6">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">Recent Skill Analyses</h2>
                  <p className="text-sm text-gray-600">{analysisHistory.length} analyses completed</p>
                </div>
              </div>
              ...
              {analysisHistory.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">Start your journey by analyzing your skills</p>
                    ...
                    <div key={idx} className="p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center space-x-2">
                          ...
                          <h3 className="font-semibold text-gray-900">{item.targetRole}</h3>
                        </div>
          ...
          <div className="animate-on-scroll" style={{ animationDelay: '0.2s' }}>
            <div className="card p-6">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">Generated Roadmaps</h2>
                  <p className="text-sm text-gray-600">{roadmapHistory.length} roadmaps created</p>
                </div>
              </div>
              ...
              {roadmapHistory.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">Create your first learning roadmap</p>
        ...
        {/* Summary Stats */}
        <div className="card p-8 mt-8 animate-on-scroll" style={{ animationDelay: '0.3s' }}>
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Your Learning Summary</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-1">Skill Analyses</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-1">Roadmaps</h4>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-accent-500 to-primary-500 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
                {analysisHistory.reduce((total, item) => total + item.skills.length, 0)}
              </div>
              <h4 className="text-lg font-semibold text-gray-900 mb-1">Skills Tracked</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-1">Active Days</h4>
